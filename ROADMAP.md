# Planned updates
Major Updates
1. V3: Break out main program in to different smaller more manageable programs.
2. v4: Add Computer Adaptive testing mode (similar to CISSP)

   
Minor Updates
1. Allow for matching type questions
